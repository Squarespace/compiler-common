 ...
 *
 * Speeds things up by about 20-30%, depending on sequence length. Greatly reduces the
 * creation of intermediate String/char[] objects, thus reducing pressure on the
 * garbage collector.
 */
